...
def execute_cmd(cmd): #MAIN executions
    ...
    elif ("торрент" in cmd) or ("открой торрент" in cmd):
    	os.system("C:/Users/yuriu/AppData/Local/MediaGet2/mediaget.exe")
    	speak.Speak("Открыл ваш торрент клиент!")

  #  elif ("автозагрузка" in cmd):
    #	subprocess.Popen('C:/Users/yuriu/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Startup')
